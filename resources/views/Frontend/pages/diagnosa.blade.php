        ...
        <div class="card kartu-custom">
            ...
            <div class="card-body">
                <form action="{{ URL::to('diagnosa') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="jenis_musang" class="col-sm-2 col-form-label text-custom">Jenis Musang</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('jenis_musang') is-invalid @enderror"
                                id="jenis_musang" name="jenis_musang" value="{{ old('jenis_musang') }}">
                            @error('jenis_musang')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
